    ...
    <div id="section-audit-interception-type" className="space-y-8">
      ...
      <SummaryBox>
        <p className="text-sm md:text-base text-slate-800 font-medium leading-relaxed">
          {highlightNumbers(
            "[[拦截结构]]：[[体育类]]为核心处置类别，拦截占比达 [[55.99%]]；其次为[[代理类]]（[[16.63%]]）与[[红利类]]（[[8.13%]]，主要覆盖场馆首存及投注豪礼）。[[站点分布]]：4站、8站、BD+XK、6+9 等重点站点合计拦截占比达 [[62.92%]]，其中[[4站单站拦截 8,990.38（占比 33.01%）]]，各品类拦截规模均居首位，为风控重点防守站点。"
          )}
        </p>
      </SummaryBox>
