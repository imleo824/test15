      ...
      <div className="bg-white border border-slate-200 border-t-2 border-t-slate-900 p-4 sm:p-5 space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 items-stretch">
            ...
            <div className="p-3.5 space-y-3 flex-1 text-xs">
              <div className="bg-slate-50 border border-slate-200 p-2.5 space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-mono text-slate-700 bg-white px-1.5 py-0.5 border border-slate-200 font-bold">
                    接口直连
                  </span>
                </div>
              ...
              <div className="bg-white p-2.5 text-xs text-slate-700 border border-slate-200 leading-relaxed">
          ...
          <div className="border border-blue-200 bg-white flex flex-col justify-between">
            ...
            {/* 卡片内容 */}
            <div className="p-3.5 space-y-3 flex-1 text-xs">
              <div className="bg-blue-50 border border-blue-200 text-blue-950 font-mono text-xs p-2 text-center font-bold tracking-tight">
                套利指数 = f(等级, 输赢, 存杠, 盈杠, 行为, 关联)
              </div>

              <div className="bg-slate-50 border border-slate-200 p-2 space-y-1.5 text-xs">
            ...
            <div className="p-3.5 space-y-2 flex-1 text-xs">
              <div className="p-2 border border-slate-300 bg-slate-50 flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-slate-700 text-xs">极速放行</span>
                </div>
                <span className="font-mono text-xs text-slate-900 font-bold bg-white px-2 py-0.5 border border-slate-300">
                  0~29 分
                </span>
              </div>
              ...
              <div className="p-2 border border-amber-200 bg-amber-50/70 flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-amber-800 text-xs">降额压缩</span>
                </div>
                <span className="font-mono text-xs text-amber-900 font-bold bg-white px-2 py-0.5 border border-amber-200">
                  30~69 分
                </span>
              </div>
              ...
              <div className="p-2 border border-rose-200 bg-rose-50/70 flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-rose-800 text-xs">阻断拦截</span>
                </div>
                <span className="font-mono text-xs text-rose-900 font-bold bg-white px-2 py-0.5 border border-rose-200">
                  70~100 分
                </span>
              </div>
              ...
              <div className="p-2 border border-blue-200 bg-blue-50/70 flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-blue-800 text-xs">激励倾斜</span>
                </div>
                <span className="font-mono text-xs text-blue-900 font-bold bg-white px-2 py-0.5 border border-blue-200">
                  优质合规
                </span>
              </div>

              <div className="bg-white p-2.5 text-xs text-slate-700 border border-slate-200 leading-relaxed mt-1">
          ...
          <div className="border border-purple-200 bg-white flex flex-col justify-between">
            ...
            <div className="p-3.5 space-y-3 flex-1 text-xs">
              <div className="bg-slate-50 border border-slate-200 p-2.5 space-y-1">
                ...
                <p className="text-slate-600 text-xs pl-3 leading-relaxed">
              ...
              <div className="bg-purple-50/50 border border-purple-200 p-2.5 space-y-1.5">
                ...
                <div className="text-xs pl-3 space-y-1 leading-relaxed">
                  <div>
