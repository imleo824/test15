    ...
    <ReportPanel tone="soft" padding="sm" className="report-module-stack h-full">
      <div className="report-module-main">
        ...
        <div className="report-module-intro">
          <ModuleBlockHeader 
            title={<><ClipboardCheck className="w-5 h-5 text-slate-900 shrink-0" /><span>6.2.1 工单系统联动</span></>} 
            right={<ReportBadge tone="green">安全联动</ReportBadge>}
          />
          <SummaryBox>
            {highlightNumbers("人工审核全面对接[[4.0风控工单系统]]。彻底剥离原有外部即时通讯群组的非公开及碎片化对接，将财务核实、代存核实、扣款、复审等[[11项核心场景]]100%全线上化闭环流转。")}
          </SummaryBox>
          ...
          <div className="mt-4 space-y-3">
            ...
            <ul className="text-sm font-normal text-slate-700 space-y-2.5">
              ...
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-blue-900 mt-1.5 shrink-0"></span>
                <span>{highlightNumbers("服务时效超时升级提示，急单平均响应降至[[1.5分钟]]")}</span>
              </li>
            </ul>
          </div>
        </div>
